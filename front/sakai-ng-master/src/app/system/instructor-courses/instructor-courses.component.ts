...
export class InstructorCoursesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.breadcrumbItems.push({ label: 'Earnings' });
  ...
  goToAddCourse() {
    this.courseService.add_course().subscribe(value => {
      let course_id = value
      console.log('id for new course ', course_id.id)
      this.router.navigate(['', 'instructor-edit-course', course_id.id])
    })
  }
